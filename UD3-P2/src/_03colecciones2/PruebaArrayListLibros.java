...
public class PruebaArrayListLibros {
	public static void main(String args[]) {
		...
		Libro l3 = new Libro("Avanzado Java", p1, "0-13-031997-X", 546, 3, "McGraw-Hill", "Madrid-Espa�a", f1);
		...
		/*
		 * int indice=a.buscar("AVANZADO"); System.out.println(indice+1); if (indice !=
		 * -1) { l3 = a.recuperar(indice+1); System.out.println(l3); } else
		 * System.out.println("No encontrado");
		 * 
		 * /* a.eliminar(2); System.out.println("Tras eliminar el 2 \n");
		 * System.out.println(a);
		 */
	}
}