...
public class Fecha {
	...
	/** Lectura de la fecha (d�a, mes y a�o). */
	public void leer() {
	...
	/** Indica si el a�o es bisiesto o no. */
	public boolean bisiesto() {
		return (_anio % 4) == 0;
	}

	/**
	 * D�as del mes de la fecha.
	 * 
	 * @param mes El mes del que se quiere saber su n�mero de d�as.
	 */
	...
	/** Devuelve los d�as transcurridos desde el 1-1-1900 hasta la fecha. */
	public long diasTranscurridos() {
		...
		for (m = 1; m < _mes; m++)
			total += diasMes(m);
		total += _dia; // Total de d�as desde 1-1-1900 hasta la fecha.
		// Incluyendo ambas fechas (se ha de restar una).
		total--;
		return total;
	}

	/** D�a de la semana de la fecha (0 para domingo). */
	...
	/**
	 * Establece la fecha que corresponde tras transcurrir los d�as que se
	 * proporcionan desde el 1-1-1900.
	 */
	...
	/** D�as entre la fecha y la proporcionada. */
	...
	/**
	 * Comprueba si la fecha es correcta y si no la ajusta. Se llama tras la lectura
	 * de los datos.
	 */
	private void valida() { // M�todo auxiliar (privado)
