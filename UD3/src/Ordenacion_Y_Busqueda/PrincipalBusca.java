...
public class PrincipalBusca {
	...
	public static void main(String[] args) {
		...
		resultado = Busca.busquedaBinaria(superonce, numero);
		if (resultado != -1)
			System.out.println(
					"El numero " + numero + " apareci� y ocupa la posicion " + resultado + " (comenzando en la 0)");
		else
			System.out.println("El numero " + numero + " no sali� premiado ");
