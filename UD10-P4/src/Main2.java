...
public class Main2 {
	...
	/*
	 * CREATE PROCEDURE jefeyPresupuesto (IN departamento INTEGER, OUT director
	 * INTEGER, OUT presupuesto INTEGER) BEGIN SELECT direc, presu INTO director,
	 * presupuesto FROM departamentos WHERE numde = departamento; END $$
	 */
}// de Main2
