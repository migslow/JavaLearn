...
public class ej08 {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		System.out.println("Introduce el numero de categoria: ");
		int c = s.nextInt();
		CallableStatement cb = conn.prepareCall("call productosCategoriaBajoMinimos (?)");
		cb.setInt(1, c);
		...
		if (rs.next()) {
			...
			System.out.println("La categoria: " + c + " o no existe o no tiene productos bajo minimos");
		}
