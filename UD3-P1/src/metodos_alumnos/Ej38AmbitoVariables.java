...
// Indicar paso de par�metros por valor....
public class Ej38AmbitoVariables {
	...
	public static void metodoPrueba() {
		...
		// System.out.println("La variable i vale "+i); ERROR aqui ya no existe la
		// variable i
	...
	public static void main(String[] args) {
		...
		// System.out.println("La variable local vale "+ variableMetodo); // ERROR aqui
		// ya no existen las variables de metodo
		...
		// System.out.println("La variable local 2 vale "+variableLocal2); Aqui ya no
		// existe la variable local 2
