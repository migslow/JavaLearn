...
public class _01fechas {
	...
	public static void main(String[] args) throws ParseException {
		...
		// Si la cadena no se ajusta al argumento patr�n, provoca excepci�n �Cu�l?
		// Al final del fichero aparecen letras para formar el patr�n.
		...
		System.out.println("Dentro de 40 d�as: " + formato2.format(calendario.getTime()));
		System.out.println("En milisegundos: " + calendario.getTimeInMillis());
		//
		/******************************************/
		/* Desde Java 8. M�S AMPLIADO EN paquete JAVA 8... */
...
/*
 * SimpleDateFormat y = year (yy or yyyy) M = month (MM) d = day in month (dd) h
 * = hour (0-12) (hh) H = hour (0-23) (HH) m = minute in hour (mm) s = seconds
