package varios;
/* Nota Alberto para esta prueba he a�adido el siguiente
 m�todo a la clase Lista
...
public class PruebaLista {
	...
	public static void main(String[] args) {
		...
		lista.insertar(new Alumno(18022501, 18, "Ana", "Gim�nez", 2));
		lista.insertar(new Alumno(18022502, 19, "Isabel", "Mart�nez", 2));
