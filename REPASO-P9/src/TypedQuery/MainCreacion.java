...
public class MainCreacion {
	...
	public static void main(String[] args) throws ParseException {
		...
		EmpleadoEntity e1 = new EmpleadoEntity(1039, "Alberto Carrera Mart�n", "Presidente", null,
				formato.parse("1999-10-27"), 4900, null, d1);
		EmpleadoEntity e2 = new EmpleadoEntity(1082, "Mario Carrera Bail�n", "Director", e1,
				formato.parse("2001-07-06"), 3385, null, d1);
		EmpleadoEntity e3 = new EmpleadoEntity(1034, "Raquel Carrera Bail�n", "Empleado", e2,
				formato.parse("2002-11-12"), 2690, null, d1);

		EmpleadoEntity e4 = new EmpleadoEntity(2066, "Blanca Bail�n Perarnau", "Director", e1,
				formato.parse("2001-07-12"), 2970, null, d2);
		EmpleadoEntity e5 = new EmpleadoEntity(2002, "Araceli Carrera Salcedo", "Investigador", e4,
				formato.parse("2003-02-24"), 3000, null, d2);
		EmpleadoEntity e6 = new EmpleadoEntity(2069, "Fernando Carrera Mart�n", "Empleado", e5,
				formato.parse("2001-11-19"), 2840, null, d2);
		EmpleadoEntity e7 = new EmpleadoEntity(2088, "Carmen Bail�n Perarnau", "Investigador", e4,
				formato.parse("2001-10-19"), 2600, null, d2);
		EmpleadoEntity e8 = new EmpleadoEntity(2076, "Fernando Carrera Salcedo", "Empleado", e7,
				formato.parse("2005-02-13"), 2730, null, d2);
		//
		EmpleadoEntity e9 = new EmpleadoEntity(3098, "Fernando Mart�nez P�rez", "Director", e1,
				formato.parse("2000-02-03"), 3150, null, d3);
		EmpleadoEntity e10 = new EmpleadoEntity(3099, "Bel�n Carrera Saus�n", "Comercial", e9,
				formato.parse("2000-02-22"), 2500, 500, d3);
		EmpleadoEntity e11 = new EmpleadoEntity(3051, "Enrique Casado Alvarez", "Comercial", e9,
				formato.parse("2002-07-23"), 2600, 550, d3);
		EmpleadoEntity e12 = new EmpleadoEntity(3054, "Antonio M�riz Piedrafita", "Comercial", e9,
				formato.parse("2003-03-22"), 2600, 1000, d3);
		EmpleadoEntity e13 = new EmpleadoEntity(3044, "Lorenzo Blasco Gonz�lez", "Comercial", e9,
