...
public class ArrayListEdificio {
	private ArrayList<Edificio> lista = new ArrayList<Edificio>();
	...
	public void ordenarPorDireccion() {
		Collections.sort(lista, new direccionComparator());
	}

	public void ordenarPorNumeroPisos() {
		Collections.sort(lista, new numerosPisosComparator());
	}
